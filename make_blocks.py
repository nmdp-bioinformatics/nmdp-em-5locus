...
# Make Blocks Generic
# Merges imputation output with pull to make two-locus

pop = sys.argv[1]
loc1 = sys.argv[2]
loc2 = sys.argv[3]
loc1_folder = sys.argv[4]
loc2_folder = sys.argv[5]
greedy_folder = sys.argv[6]
...
# get GLIDs from Greedy GLID file
glstring = {} # stores GL String for each GLID
glid_filename = "./" + greedy_folder + "/glid." + pop + ".txt"
...
if ("~" in loc1):
    impute_filename = "./" + loc1_folder + "/impute." + pop + ".csv.gz"
...
# if locus name has "~", use imputation output file
if ("~" in loc2):
    impute_filename = "./" + loc2_folder + "/impute." + pop + ".csv.gz"
    impute_file = gzip.open(impute_filename,'rt')
    freqnorm_highest = {}
    imputed_genos = {}
    for line in impute_file:
...
# Load Pull file
pull_filename = "./" + greedy_folder + "/pull." + pop + ".txt"
...
if ((loc1 == "DRBX") & (loc2 == "DRB1")):
    ...
    restricted_DRBX_DRB1_filename = "./DRBXDRB1/restricted.DRBXDRB1." + pop + ".txt"
...
# print new GLID file
new_glid_filename = "./" + loc_folder_out +  "/glid." + pop + ".txt"
...
new_pull_filename = "./" + loc_folder_out + "/pull." + pop + ".txt"
...
# print EM input file
nemo_filename = "./" + loc_folder_out + "/nemo." + pop + ".txt"
